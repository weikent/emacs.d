...
(when (display-graphic-p) 
  (setq fonts 
        (cond ((eq system-type 'darwin)     '("Inconsolata"     "STHeiti"    "Inconsolata")) 
              ((eq system-type 'gnu/linux)  '("Menlo"     "WenQuanYi Zen Hei")) 
              ((eq system-type 'windows-nt) '("Consolas"  "Microsoft Yahei")))) 

 ;; (setq face-font-rescale-alist '(("STHeiti" . 1.1) ("Microsoft Yahei" . 1.1) ("WenQuanYi Zen Hei" . 1.1) ("Inconsolata" . 1.1))) 
